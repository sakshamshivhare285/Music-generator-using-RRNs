import os
import json
from model import load_weights, build_model
import argparse
import numpy as np
import tensorflow
from tensorflow import keras
from keras.models import Sequential
from keras.layers import Dense, TimeDistributed, LSTM, Embedding, Dropout, Activation
...
if __name__ == '__main__':
   ...
   #parser.add_argument('--seed', default='', help='initial seed for the generated text')
    ...
    print(sample(args.epoch, args.len))
